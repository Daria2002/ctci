...
namespace MatrixFile 
{
    ...
    {
        public:
            bool initalize_matrix(const std::string&, std::vector<std::vector<int>>&);
...
bool MatrixFile::MatrixManager::initalize_matrix(const std::string& file_name, std::vector<std::vector<int>>& matrix) {
    std::ifstream file;
    file.open(file_name);
...
bool MatrixFile::MatrixManager::write_matrix_to_file(const std::string& file_name, const std::vector<std::vector<int>>& matrix) {
